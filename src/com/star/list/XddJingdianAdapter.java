 ...
 * 
 */
public class XddJingdianAdapter extends CommonAdapter<YuLu> {
	 ...
	 * @param itemLayoutId
	 */
	public XddJingdianAdapter(Context mContext, List<YuLu> mDatas, int itemLayoutId) {
	...
	public void convert(ViewHolder mViewHolder, YuLu yulu) {
		...
		mViewHolder.setText(R.id.situation, yulu.getSituation());
	}
